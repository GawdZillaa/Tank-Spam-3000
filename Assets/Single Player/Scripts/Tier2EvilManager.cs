...
public class Tier2EvilManager : MonoBehaviour {
    ...
    public void takeDamage(int amount)
    {
        ...
        if (health <= 0 || health == 0)
        {
            ...
            if (stopHealth == false)
            {
                ...
                GameOver.GetComponent<GameOverManager>().PlayerRegisterKill(2);

                audio.PlayOneShot(explode);
                resources.GetComponent<ResourceManagerG>().killResource(30);
